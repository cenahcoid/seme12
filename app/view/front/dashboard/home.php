      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text text-center"><b>Cerita Tentang Hero Kimmy</b></p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="kimmy" ><button type="button" class="btn btn-primary btn-outline-secondary" style="color:#ffffff;">View</button></a>
                </div>
                <small class="text-muted">11 mins</small>
              </div>
            </div>
        ...
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="brody" ><button type="button" class="btn btn-primary btn-outline-secondary" style="color:#ffffff;">View</button></a>
                </div>
                <small class="text-muted">11 mins</small>
              </div>
            </div>
        ...
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="ruby" ><button type="button" class="btn btn-primary btn-outline-secondary" style="color:#ffffff;">View</button></a>
                </div>
                <small class="text-muted">11 mins</small>
              </div>
            </div>
