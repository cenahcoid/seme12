<div class="row " style="padding-top:100px;">
  ...
  <div class="col-md-8">
    <h1><b>Kisah Hero Miya: Putri Dari Kerajaan Yang Menjadi Petualang Tangguh Di Mobile Legends.</b></h1>
    <br />
        ...
        kedua perajurit tersebut kemudian bekerja sama dan melawan pasukan iblis yang menyerang kerajaan miya</p>
        <p style="font-size:20px;">Dalam pertempuran tersebut, dia dan prajrit tersebut berhasil mengalahkan seluruh pasukan iblis tersebut dan menyelamatkan kerajaan Miya. Setelah berhasil menyelamatkan kerajaan, Miya memutuskan Untuk tidak kembali ke kerajaannya yang hancur.</p>
        <img src="media/elite.png" alt="Nature" class="responsive">

        <p style="font-size:20px;">Ia memilih untuk menjadi seorang patualang dan membantu orang-orang yang membutuhkan bantuan. Hero ini bergabung dengan sebuah kelompok petualang yang sangat terkenal dengna keberanian dalam menghadapi bahaya. Dalam petualangan nya, Miya terus mengasah keahliannya dalam menggunakan panah.</p>
        <p style="font-size:20px;">Ia juga menemukan sebuah panah yang sangat khusus, yaotu panah yang bisa mengeluarkan cahaya yang sangat terang. Panah tersebut menjadi senjata sandalannya dalam menghadapi musuh-musuhnya.</p>
        <p style="font-size:20px;">Kesimpulannya, Miya merupakan hero yang sangat tangguh dan memiliki keahlian yang sangat berguna dalam pertempuran. Kisahnya yang heroik dan petualangannya yang penuh bahaya membuatnya menjadi salah satu hero yang paling populer di Mobile Legends.</p>
        <p style="font-size:20px;">Bagi para penggemar Mobile Legends, Miya tentu saja menjadi salah satu hero yang wajib di coba ***</p>
        </div>
        <div class="col-md-2">
